...
///
/// The `JobsScreen` class provides static methods and properties to access
...
/// ```dart
/// JobsScreen.setUp();
/// double screenWidth = JobsScreen.width;
/// double screenHeight = JobsScreen.height;
/// ```
///
/// Rationale:
///
/// - The `JobsScreen` class provides a convenient way to access the screen dimensions
...
/// the `JobsScreen` class benefits from its reliability and compatibility with different
...
class JobsScreen {
  ...
  static Size get _size => MediaQuery.sizeOf(JobsBd.globalContext);
  ...
  static void _resetIfInvalid() {
    if (_width! < 10 || _height! < 10) {
      logErrorStatic(
        'JobsScreen size not initialized. Please initialize JobsScreen and try again.',
        "Tutor_screen",
      );
      _width = null;
      _height = null;
...
extension JobsScreenWidth on Widget {
  ...
  double get twoPercentWidth {
    ...
    _twoPercentWidth ??= JobsScreen.width * twoPercent;
  ...
  double get fiftyPercentHeight {
    ...
    _fiftyPercentHeight ??= JobsScreen.height * fiftyPercent;
  ...
  double get threePercentWidth {
    ...
    _threePercentWidth ??= JobsScreen.width * threePercent;
  ...
  double get sixPercentWidth {
    ...
    _sixPercentWidth ??= JobsScreen.width * sixPercent;
  ...
  double get sevenPercentWidth {
    ...
    _sevenPercentWidth ??= JobsScreen.width * sevenPercent;
  ...
  double get eightPercentWidth {
    ...
    _eightPercentWidth ??= JobsScreen.width * eightPercent;
  ...
  double get tenPercentWidth {
    ...
    _tenPercentWidth ??= JobsScreen.width * tenPercentWidth;
  ...
  double get fortyPercentWidth {
    ...
    _fortyPercentWidth ??= JobsScreen.width * fortyPercent;
  ...
  double get thirtyPercentWidth {
    ...
    _thirtyPercentWidth ??= JobsScreen.width * thirtyPercentWidth;
  ...
  double get seventyPercentWidth {
    ...
    _seventyPercentWidth ??= JobsScreen.width * seventyPercent;
  ...
  double get tweentyEightPercentWidth {
    ...
    _tweentyEightPercentWidth ??= JobsScreen.width * tweentyEightPercentWidth;
  ...
  double get twentyPercentWidth {
    ...
    _twentyPercentWidth ??= JobsScreen.width * twentyPercentWidth;
  ...
  double get twentyFivePercentWidth {
    ...
    _twentyFivePercentWidth ??= JobsScreen.width * twentyFivePercentWidth;
  ...
  double get twentySixPercentWidth {
    ...
    _twentySixPercentWidth ??= JobsScreen.width * twentySixPercentWidth;
  ...
  double get twentyThreePercentWidth {
    ...
    _twentyThreePercentWidth ??= JobsScreen.width * twentyThreePercentWidth;
  ...
  double get fourtyPercentWidth {
    ...
    _fourtyPercentWidth ??= JobsScreen.width * fourtyPercentWidth;
  ...
  double get twentyPercentHeight {
    ...
    _twentyPercentHeight ??= JobsScreen.height * twentyPercent;
  ...
  double get tenPercentHeight {
    ...
    _tenPercentHeight ??= JobsScreen.height * tenPercentHeight;
  ...
  double get twelvePercentHeight {
    ...
    _twelvePercentHeight ??= JobsScreen.height * twentyPercent;
  ...
  double get fourteenPercentHeight {
    ...
    _fourteenPercentHeight ??= JobsScreen.height * fourteenPercentHeight;
  ...
  double get tweentyPercentHeight {
    ...
    _tweentyPercentHeight ??= JobsScreen.height * tweentyPercentHeight;
...
double? _jobsScreenWidthQuarterPercentage;
...
/// `_widthPercent`, and `_JobsScreenWidthQuarterPercentage`), subsequent conversions for the same
...
extension DeviceExt on num {
  ...
  /// `_calculateJobsScreenWidthQuarterPercentage` function.
  ///
  ///
  /// Example usage:
  ///
  ...
  /// ```
  double get px {
    _jobsScreenWidthQuarterPercentage ??=
        _calculateJobsScreenWidthQuarterPercentage();
    return this * (_jobsScreenWidthQuarterPercentage ?? 0);
  }
  ...
  double get percentHeight {
    _heightPercent ??= JobsScreen.height / 100;
  ...
  double get percentWidth {
    _widthPercent ??= JobsScreen.width / 100;
...
///
/// The `_calculateJobsScreenWidthQuarterPercentage` function calculates and returns
...
///
/// This function assumes that the `JobsScreen` class, containing the width property,
/// is properly defined and accessible within the scope of this function.
double _calculateJobsScreenWidthQuarterPercentage() {
  return (JobsScreen.width / 3.9) / 100;
}
