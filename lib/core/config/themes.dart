...
import 'package:jobs_bd/core/config/job_app_color.dart';
import 'package:jobs_bd/core/static/constants.dart';
import 'package:jobs_bd/core/static/font_family.dart';
...
class TutorTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      scaffoldBackgroundColor: JobsAppColor.scaffoldBachgroundColor,
      cardColor: JobsAppColor.cardColor,
      primaryColor: JobsAppColor.primaryColor,
      colorScheme: const ColorScheme.light(
        primary: JobsAppColor.primaryColor,
        secondary: JobsAppColor.secondaryColor,
        surface: JobsAppColor.cardColor,
        onSurface: JobsAppColor.textColor,
        onPrimary: JobsAppColor.textColor,
        onSecondary: JobsAppColor.textColor,
      ),
      useMaterial3: true,
      appBarTheme: const AppBarTheme(
          backgroundColor: JobsAppColor.appbarColor,
...
Future<SystemUiOverlayStyle?> getSystemUiOverlayStyle({
  ...
  final SystemUiOverlayStyle? uiOverlayStyle =
    ...
    final ThemeData theme = Theme.of(context ?? JobsBd.globalContext);
